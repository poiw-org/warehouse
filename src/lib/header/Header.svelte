<script lang="ts">
	...
	import { faDoorOpen, faArrowRight, faSearch } from '@fortawesome/free-solid-svg-icons'
...
<span class="px-10 py-10 flex md:justify-between md:items-center flex-col md:flex-row gap-4">
    ...
    <span class="flex gap-10 flex-col-reverse md:flex-row mt-5 md:mt-0">
            ...
            <a href="/login" class="flex items-center gap-2"><Fa icon={faDoorOpen}/>LOG IN</a>
            {/if}
        </span>
</span>